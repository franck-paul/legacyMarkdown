...
L10n::$locales['Convert to Markdown'] = 'Convertir en Markdown';
L10n::$locales['Don\'t forget to validate your Markdown conversion by saving your post.'] = 'N\'oubliez pas de valider votre conversion Markdown en sauvegardant votre entrée.';
...
L10n::$locales['Linebreak '] = 'Passage à la ligne';
L10n::$locales['Preformatedtext'] = 'Texte préformatté';
L10n::$locales['Unorderedlist'] = 'Liste non ordonnée';
L10n::$locales['Orderedlist'] = 'Liste ordonnée';
...
L10n::$locales['Footnote'] = 'Note de bas de page';
L10n::$locales['Format'] = 'Format';
L10n::$locales['Comments can be formatted using the <a href="https://michelf.ca/projects/php-markdown/extra/">Markdown Extra</a> syntax.'] = 'Les commentaires peuvent être formatés en utilisant la syntaxe <a href="https://michelf.ca/projects/php-markdown/extra/">Markdown Extra</a>.';
L10n::$locales['Back to content %%'] = 'Retour au contenu %%';
